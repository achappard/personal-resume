<section id="short-profil" class="resume-section css-animation-element css-slide-up">
	<p class="text-center">
		Bonjour, je suis Aurélien CHAPPARD, <strong>concepteur développeur multimédia</strong> à Lyon.
	</p>
	<p class="text-center">
