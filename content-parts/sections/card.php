        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="list-inline list-unstyled text-center">
                    ...
                    <li><div class="css-animation-element css-fade"><a target="_blank" href="https://www.developpeur-wordpress-lyon.com/"><span class="icon icon-wordpress"></span><span class="sr-only">Développeur Wordpress</span></a></div></li>
